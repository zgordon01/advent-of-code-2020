    ...
    public class Day5: Problem
    {
        ...
        public string FinalAnswerPart1()
        {
            ...
            boardingPasses.ForEach(pass =>
            {
                ...
                foreach (var specifier in pass.rowSpecifiers)
                {
                    ReducePlaneRows(ref planeRows, specifier);
                }
                pass.row = planeRows[0];
                
                foreach (var specifier in pass.columnSpecifiers)
                {
                ...
                highestSeatId = pass.seatID > highestSeatId ? pass.seatID : highestSeatId;

            });
            // boardingPasses.ForEach(x =>
            // {
            //     highestSeatID = x.seatID > highestSeatID ? x.seatID : highestSeatID;
            // });
